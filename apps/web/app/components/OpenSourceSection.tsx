		...
		>
			<div className="max-w-4xl mx-auto text-center">
				...
				<p className="text-gray-400 text-lg mb-10 max-w-2xl mx-auto">
					Simple Calorie Tracker is fully open source. Inspect the code,
					contribute, or self-host the backend. Built by{" "}
					<a
						href="https://github.com/antomanc"
				...
				<div className="bg-surface border border-white/5 rounded-2xl p-8 mb-8 text-left max-w-2xl mx-auto">
					<div className="flex items-center gap-3 mb-4">
						...
						<code className="text-primary text-sm">
							github.com/antomanc/simple-calorie-tracker
						</code>
					</div>
				...
				<a
					href="https://github.com/antomanc/simple-calorie-tracker"
					target="_blank"
					rel="noopener noreferrer"
				...
				<p className="text-gray-600 text-sm mt-12">
					© 2026 Antonio Mancini. MIT License.
				</p>
			</div>
		</footer>
	)
